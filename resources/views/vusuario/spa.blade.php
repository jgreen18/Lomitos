    ...
    <section class="md:h-full flex items-center text-gray-600">
        <div class="container px-5 py-12 mx-auto">
            <div class="text-center mb-12">
                <h5 class="text-base md:text-lg text-indigo-700 mb-1">Consiente a tu lomito con nuestro</h5>
                <h1 class="text-4xl md:text-6xl text-gray-700 font-semibold">Servicio de Spa</h1>
            </div>
