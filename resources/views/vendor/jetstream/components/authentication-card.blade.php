<div class="flex flex-col md:flex-row h-screen items-center">
    ...
    <div class="bg-white items-center justify-center flex md:mx-auto md:mx-0 md:max-w-md lg:max-w-full w-full md:w-1/2 xl:w-1/3 px-6 lg:px-16 xl:px-12"><!--Diseño de la tarjeta-->
